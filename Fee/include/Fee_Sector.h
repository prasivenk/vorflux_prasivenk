...
Std_ReturnType Fee_Sector_EraseImmediate(uint16 BlockNumber, Fee_BlockInfoType* BlockInfo, Fee_BlockInfoType* BlockInfoTable, uint16 NumBlocks, const Fee_BlockConfigType* BlockConfig);
